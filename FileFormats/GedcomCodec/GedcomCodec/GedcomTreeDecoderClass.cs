...
namespace FamilyStudioData.FileFormats.GedcomCodec
{
    ...
    class GedcomTreeDecoderClass
    {
        ...
        public GedcomTreeDecoderClass(ref IFamilyTreeStoreBaseClass inFamilyTree, ref GedcomImportResult importResult)
        {
            ...
            for (int i = 0; i < gedcomLineObject.gedcomLines.Count; i++)
            {
                ...
                if (CheckTag(ref tagStack, subLineData))
                {
                    ...
                    switch (subLineData.tagString)
                    {
                        ...
                        case "ADR3":
                            {
                                tempAddress.AddAddressPart(AddressPartClass.AddressPartType.Line3, subLineData.valueString);
                            }
                            break;
                ...
                if (CheckTag(ref tagStack, subLineData))
                {
                    ...
                    switch (subLineData.tagString)
                    {
                        ...
                        case "RELI":
                            {
                                //DebugStringAdd("decoded date: " + tempDate);
                                tempEvent.SetEventData("RELI", subLineData.valueString);
                            }
                            break;
            ...
            for (int i = 0; i < gedcomLineObject.gedcomLines.Count; i++)
            {
                ...
                if (CheckTag(ref tagStack, lineData))
                {
                    ...
                    switch (lineData.tagString)
                    {
                        ...
                        case "_UID":
                            {
                                tempIndividual.SetSpecialRecordId(IndividualClass.IndividualSpecialRecordIdType.UniversalRecordId, lineData.valueString);
                            }
                            break;
                ...
                for (int j = 0; j < lineData.child.gedcomLines.Count; j++)
                {
                    ...
                    if (CheckTag(ref tagStack, line))
                    {
                        ...
                        switch (line.tagString)
                        {
                            ...
                            case "_GOV":
                                place.SetPlaceData("_GOV", line.valueString);
                                break;

                            case "_LOC":
                                place.SetPlaceData("_LOC", line.valueString);

                                break;

                            case "MAP":
                                if (line.child.gedcomLines.Count > 1)
                                {
                                    place.SetPlaceData("MAP", line.valueString);
                                    foreach (var subLine in line.child.gedcomLines)
                                        if (new string[] { "LATI", "LONG" }.Contains(subLine.tagString))
                                            place.SetPlaceData($"MAP.{subLine.tagString}", subLine.valueString);
                                }
            ...
            for (int i = 0; i < gedcomLineObject.gedcomLines.Count; i++)
            {
                ...
                if (CheckTag(ref tagStack, lineData))
                {
                    ...
                    switch (lineData.tagString)
                    {
                        ...
                        case "RESI":
                            {
                                ...
                                {
                                    IndividualEventClass tempEvent = new IndividualEventClass();
                                    DecodeGedcomEventDetail(tagStack, lineData.child, IndividualEventClass.EventType.FamResidence, ref tempEvent);
                                    tempFamily.AddEvent(tempEvent);
                                }
                            }
                            break;
                        ...
                        case "_UID":
                            {
                                tempFamily.SetSpecialRecordId(FamilyClass.FamilySpecialRecordIdType.UniversalRecordId, lineData.valueString);
                                CheckUndecodedChildren(tagStack, lineData.child);
                            }
                            break;
                        ...
                        case "_UID":
                            {
                                if (lineData.child != null)
                                {
                                    tempRepository.SetUID(lineData.valueString);
                                }
                            }
                            break;
                        ...
                        case "_UID":
                            {
                                if (lineData.child != null)
                                {
                                    tempSource.SetUID(lineData.valueString);
                                }
                            }
                            break;
                        default:
