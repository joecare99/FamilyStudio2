...
namespace FamilyStudioData.FamilyData
{
    ...
    public class PlaceStructureClass
    {
        ...
        [DataMember]
        private IDictionary<string,string> placeData;
        ...
        public PlaceStructureClass(string place = null)
        {
            ...
            placeData = new Dictionary<string, string>();
            if (place != null)
            {
                placeValue = place;
            }
        ...
        public void SetPlaceData(string key, string value)
        {
            placeData[key] = value;
        }
        public string? GetPlaceData(string key)
        {
            if (placeData.ContainsKey(key))
            {
                return placeData[key];
            }
            return null;
        }
