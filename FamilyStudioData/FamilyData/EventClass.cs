...
namespace FamilyStudioData.FamilyData
{
    ...
    public class IndividualEventClass
    {
        ...
        [DataMember]
        private IDictionary<string,string> eventData;
        [DataMember]
        private IList<IndividualXrefClass> personXrefList;
        ...
        public IndividualEventClass(EventType inEventType = EventType.Unknown):this(inEventType, new FamilyDateTimeClass())
        {
        }
        ...
        public void SetEventData(string v, string valueString)
        {
            eventData[v] = valueString;
        }
    }
